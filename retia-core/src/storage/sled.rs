...
/// You should use [`new_retia_rocksdb`](crate::new_retia_rocksdb) or
/// [`new_retia_sqlite`](crate::new_retia_sqlite) instead.
pub fn new_retia_sled(path: impl AsRef<Path>) -> Result<crate::Db<SledStorage>> {
